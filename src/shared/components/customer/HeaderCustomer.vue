  ...
  <header class="bg-white shadow-sm sticky top-0 z-40">
    <div class="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
      ...
      <nav class="hidden md:flex gap-8 font-medium text-gray-600">
        ...
        <RouterLink to="/about-us" exact-active-class="text-primary-600 !border-primary-500 font-semibold" class="hover:text-primary-500 transition-colors border-b-2 border-transparent py-1">Về chúng tôi</RouterLink>
