...
<template>
  ...
  >
    <div class="w-full max-w-md rounded-2xl bg-white p-8 shadow-2xl relative overflow-hidden">
      ...
      <h2 class="mb-6 text-center text-3xl font-bold text-gray-800">Khôi Phục Mật Khẩu</h2>
      ...
      <div
        ...
        class="mb-6 rounded-lg bg-green-50 p-4 text-sm text-green-600 border border-green-100"
      >
        {{ successMessage }}
      </div>
      ...
      <p class="mt-6 text-center text-sm text-gray-600">
        Nhớ mật khẩu rồi?
        <button @click="backToLogin" class="font-medium text-primary-600 hover:text-primary-500">
          Quay lại đăng nhập
        </button>
      </p>
    </div>
